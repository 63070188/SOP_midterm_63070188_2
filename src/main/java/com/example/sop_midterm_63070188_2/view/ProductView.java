package com.example.sop_midterm_63070188_2.view;
...
//        productList.addValueChangeListener(event -> {
//            System.out.println(this.productList.getValue());
//            try {
//            if(!this.productList.getValue().equals("") && this.productList.getValue() != null ) {
//                this.productNow = (Product) rabbitTemplate.convertSendAndReceive("ProductExchange", "getname", this.productList.getValue());
//                productName.setValue(this.productNow.getProductName());
//                productCost.setValue(this.productNow.getProductCost());
//                productProfit.setValue(this.productNow.getProductProfit());
//                productPrice.setValue(this.productNow.getProductPrice());
...
//                productPrice.setValue(0.0);
//            }
////            System.out.println(this.productNow);
//        });
